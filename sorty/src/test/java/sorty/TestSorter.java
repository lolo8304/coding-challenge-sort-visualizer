...
public class TestSorter extends Sorter {
    ...
    public TestSorter(int n, int from, int to, SortDirection direction, int seed) {
        super(n, from, to, direction, seed, SortAlgorithm.BUBBLE, SortSpeed.FAST, new NoOpUiDelegate());
    }
    ...
    public TestSorter(Integer[] numbers, SortDirection direction) {
        super(numbers.length, 1, 100, direction, 0, SortAlgorithm.BUBBLE, SortSpeed.FAST, new NoOpUiDelegate());
